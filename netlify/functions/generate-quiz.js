...
// Fitur "self-healing": kalau output AI tidak valid (JSON // netlify/functions/generate-quiz.js
//
// Endpoint: POST /.netlify/functions/generate-quiz
// Body: { text: string, numMcq: number, numEssay: number, difficulty: string }
//
...
exports.handler = async function (event) {
  ...
  // Kalau soal yang diminta banyak (>25), kurangi jumlah percobaan self-healing
  // biar total waktu eksekusi function nggak kelewat batas timeout Netlify.
